...
class LitnetBookListView(generic.ListView):
    template_name = 'parser/litnet_book_list.html'
    context_object_name = 'litnet'
    model = models.LitnetBooksModel

    def get_queryset(self):
        return models.LitnetBooksModel.objects.all()
